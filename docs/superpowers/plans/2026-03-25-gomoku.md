...
Run: `open <project-root>/index.html`
...
Run: `open <project-root>/tests/test-runner.html`
...
1. Open `<project-root>/index.html` in Chrome.

## Run the tests

1. Open `<project-root>/tests/test-runner.html` in Chrome.
